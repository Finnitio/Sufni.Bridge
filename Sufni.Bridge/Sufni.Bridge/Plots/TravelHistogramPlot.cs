...
public class TravelHistogramPlot(Plot plot, SuspensionType type) : TelemetryPlot(plot)
{
    ...
    private void AddStatistics(TelemetryData telemetryData, double yRangeTop)
    {
        ...
        AddLabel("avg", statistics.Average, yRangeTop * 0.9, -8, 0, Alignment.MiddleRight);
        AddLabel("max", statistics.Max, yRangeTop * 0.9, -8, 0, Alignment.MiddleRight);
        AddLabel("95th", statistics.P95, yRangeTop * 0.9, -8, 0, Alignment.MiddleRight);
        ...
        statsLabel.LabelAlignment = Alignment.MiddleLeft;
    }
